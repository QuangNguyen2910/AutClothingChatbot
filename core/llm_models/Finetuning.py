...
if __name__ == "__main__":
    # model, tokenizer = ChatbotModel("Quangnguyen711/clothes_shop_chatbot_QLoRA",
    #                                 True, 2048, None).get_pretrained_model()
    ...
    # train(model, tokenizer, dataset, packing = False)

    # save_model(model, tokenizer, local = False, online = False, merged_16_bit = False, merged_4_bit = False, lora = True, gguf = False, quantization_method = "q8_0", hf_write_token = "")
    print("This is a module for fine-tuning the model.")